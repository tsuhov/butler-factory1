...
if (!GITHUB_TOKEN) {
    // Эта ошибка важна для локального тестирования, в GitHub Actions токен всегда будет
    console.warn(`[!] [Поток #${threadId}] Не был предоставлен GITHUB_TOKEN! Публикация будет невозможна.`);
}
...
async function main() {
    // Настраиваем Git прямо в начале
